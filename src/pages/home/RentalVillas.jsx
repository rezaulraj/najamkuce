      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Discover Croatia's{" "}
            <span className="text-[#25A69A]">Finest Villas</span>
          </h2>
          ...
          {places.slice(0,6).map((place, index) => (
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                {/* Price Tag */}
                <div className="absolute bottom-4 right-4 bg-[#25A69A] text-white px-3 py-1 rounded-lg font-semibold shadow-lg">
                  {place.price}
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center text-gray-600 mb-4">
                  <FiMapPin className="mr-2 text-[#25A69A]" />
                ...
                {/* View Button */}
                <button className="mt-6 w-full bg-[#25A69A] hover:bg-[#1E8C82] text-white font-medium py-2 px-4 rounded-lg transition-colors duration-300">
                  View Details
                </button>
              </div>
            </motion.div>
